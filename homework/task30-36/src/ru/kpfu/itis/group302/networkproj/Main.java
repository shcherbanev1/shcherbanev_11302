package ru.kpfu.itis.group302.networkproj;

import ru.kpfu.itis.group302.networkproj.models.*;
import ru.kpfu.itis.group302.networkproj.services.*;
...
public class Main {
	...
	public static void main(String [] args) {
		...
		*/
		...
		// Задание 30
		String ans30 = s.getMaxSubsFromUserCity();
		System.out.println(ans30);
		
		// Задание 31
		String ans31 = s.groupAllMembersNotFromAdminCity();
